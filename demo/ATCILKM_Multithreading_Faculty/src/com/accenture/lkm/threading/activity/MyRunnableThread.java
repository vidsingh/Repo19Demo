...
//TODO 1 - Implement Runnable interface
...
//Overriding run method
	public void run() {
		...
		for(int i = 0; i<5; i++) {
			System.out.println("Entering method by ------ " + Thread.currentThread().getName() + " value of i " + i);
			System.out.println("inside method " + Thread.currentThread().getName()+ " value of i " + i);
			System.out.println("Existing method by ------ " + Thread.currentThread().getName()  + " value of i " + i);
		}
